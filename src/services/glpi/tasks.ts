/**
 * Buscas de TicketTask (apontamentos) e calculo de horas planejadas/realizadas/legadas.
 *
 * IMPORTANTE: a fonte de verdade da metrica "Total Realizado" e o
 * campo `actiontime` do proprio ticket (search id 49), capturado em
 * parseGLPITicket(). As funcoes deste modulo servem para enriquecer
 * com breakdown por colaborador / planejado x realizado, NUNCA para
 * substituir o agregado oficial. Se o filtro de whitelist
 * (VITE_RPA_COLLABORATORS) ou de categoria zerar tudo, o card ainda
 * mostra o numero do ticket porque applyTaskBreakdownToTicket so
 * sobrescreve quando ha dados nas tasks.
 */
